...
export const SERVICE_REGISTRY_L2_CONTRACT: Record<number, Address> = {
  [Chain.GNOSIS]: '0x9338b5153AE39BB89f50468E608eD9d764B755fD',
};

export const SERVICE_REGISTRY_TOKEN_UTILITY_CONTRACT: Record<number, Address> =
  {
    [Chain.GNOSIS]: '0xa45E64d13A30a51b91ae0eb182e88a40e9b18eD8',
  };

export const SERVICE_STAKING_TOKEN_MECH_USAGE_CONTRACT: Record<
  number,
  Address
> = {
...
export const AGENT_MECH_CONTRACT: Record<number, Address> = {
